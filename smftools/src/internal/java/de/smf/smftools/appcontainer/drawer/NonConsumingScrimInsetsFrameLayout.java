...
public final class NonConsumingScrimInsetsFrameLayout extends FrameLayout {
  ...
  private void init(Context context, AttributeSet attrs, int defStyle) {
    TypedArray a =
        context.obtainStyledAttributes(attrs, R.styleable.NonConsumingScrimInsetsFrameLayout, defStyle, 0);
    if (a == null) {
      return;
    }
    insetForeground = a.getDrawable(R.styleable.NonConsumingScrimInsetsFrameLayout_insetForeground);
    a.recycle();
